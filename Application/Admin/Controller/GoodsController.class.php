...
class GoodsController extends AdminController
{
    ...
    public function editing()
    {
        ...
        $data=array(
            ...
            'type'=>I('type'),
            'price'=>I('price'),
            'settle_price'=>I('settle_price'),
            'integral'=>I('integral'),
            'expire'=>strtotime(I('expire')),
            'platform'=>trim(I('platform')),
            'bcsp_goods_code'=>trim(I('bcsp_goods_code')),
           // 'stock'=>I('stock'),
            'status'=>I('status'),
            'pic_url'=>trim(I('pic_url')),
            'brand_id'=>trim(I('brand_id')),
            'description1'=>trim(I('description1')),
            'description2'=>trim(I('description2')),
            'description3'=>trim(I('description3')),
            'description4'=>trim(I('description4')),
            'description5'=>trim(I('description5')),
            'description6'=>trim(I('description6')),
            'description7'=>trim(I('description7')),
            'description8'=>trim(I('description8')),
            'description9'=>trim(I('description9'))
